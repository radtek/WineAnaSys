...
BOOL CDBManageTrueDlg::OnInitDialog()
{
	...
	///////////////////
	m_ListSpectrumToAdd.InsertColumn( 0, L"光谱文件名", LVCFMT_LEFT,100 );//插入列 
	m_ListSpectrumToAdd.InsertColumn( 1, L"白酒名称", LVCFMT_LEFT, 100 );//插入列 
	m_ListSpectrumToAdd.InsertColumn( 2, L"白酒信息", LVCFMT_LEFT, 150 );//插入列 
	m_ListSpectrumToAdd.InsertColumn( 3, L"生产日期", LVCFMT_LEFT, 100 );//插入列 
	m_ListSpectrumToAdd.InsertColumn( 4, L"生产批号", LVCFMT_LEFT, 100 );//插入列 
	m_ListSpectrumToAdd.InsertColumn( 5, L"来源说明", LVCFMT_LEFT, 100 );//插入列 
	m_ListSpectrumToAdd.InsertColumn( 6, L"接收日期", LVCFMT_LEFT, 100 );//插入列 
	...
	m_ListSpectrunQueryed.InsertColumn( 0, L"白酒名称", LVCFMT_LEFT, 100 );//插入列 
	m_ListSpectrunQueryed.InsertColumn( 1, L"白酒信息", LVCFMT_LEFT, 150 );//插入列 
	m_ListSpectrunQueryed.InsertColumn( 2, L"生产日期", LVCFMT_LEFT, 100 );//插入列
	m_ListSpectrunQueryed.InsertColumn( 3, L"生产批号", LVCFMT_LEFT, 100 );//插入列
	m_ListSpectrunQueryed.InsertColumn( 4, L"来源说明", LVCFMT_LEFT, 100 );//插入列
	m_ListSpectrunQueryed.InsertColumn( 5, L"入库日期", LVCFMT_LEFT, 100 );//插入列
...
UINT ThreadAddSpecToLib(LPVOID lpParam)
{
	...
	pDBManageTrueDlg->MessageBox(L"数据导入成功",L"数据入库",MB_ICONINFORMATION);
	return 0;
}
