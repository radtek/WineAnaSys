...
BOOL CDataServerCenterApp::InitInstance()
{
	...
	g_ArrayComponnetName.Add(L"乙醛");
	g_ArrayComponnetName.Add(L"乙酸乙酯");
	g_ArrayComponnetName.Add(L"甲醇");
	g_ArrayComponnetName.Add(L"丁酸乙酯");
	g_ArrayComponnetName.Add(L"正丙醇");
	g_ArrayComponnetName.Add(L"异丁醇");
	g_ArrayComponnetName.Add(L"戊酸乙酯");
	g_ArrayComponnetName.Add(L"正丁醇");
	g_ArrayComponnetName.Add(L"异戊醇");
	g_ArrayComponnetName.Add(L"乙酸乙酯");
	g_ArrayComponnetName.Add(L"庚酸乙酯");
	g_ArrayComponnetName.Add(L"乳酸乙酯");
	g_ArrayComponnetName.Add(L"糠醛");
	g_ArrayComponnetName.Add(L"己酸");
	g_ArrayComponnetName.Add(L"β-苯乙醇");
	g_ArrayComponnetName.Add(L"乳酸");
	g_ArrayComponnetName.Add(L"乙酸");
