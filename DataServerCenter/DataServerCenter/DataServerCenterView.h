...
#define WM_ENTERSYSTEMMAINUI    (WM_USER+1006)

#define ID_BUTTON_ENTERSYSTEMMAINUI 1000
...
public:
	...
	afx_msg void OnDeletefinpro();
	afx_msg void OnManualana();
	afx_msg void OnTracebackhistory();
	afx_msg void OnDbbackupandrestore();
	afx_msg void OnEnterSystemMainui();
	afx_msg void OnResultDetail();
