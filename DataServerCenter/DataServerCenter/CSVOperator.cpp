...
bool CCSVOperator::GetDouble(u32 uiLine, u32 uiRow, double& fValue)
{
    std::string* pKey = GetString(uiLine, uiRow);
    if (pKey)
    {
...
CString CCSVOperator::GetCString(u32 uiLine, u32 uiRow)
{
	CString retn;
    std::string* pKey = GetString(uiLine, uiRow);
    if (pKey)
...
bool CCSVOperator::SetNumber(u32 uiLine, u32 uiRow, double fValue)
{
    std::string* pKey = GetString(uiLine, uiRow);
    if (pKey)
    {
