...
#include "btnst.h"
#include "UpdateModelProgressDlg.h"
...
public:
	...
	void UpdateConcentrationTraceBackModel(void);
	...
	CUpdateModelProgressDlg *m_pCUpdateModelProgressDlg;
	virtual BOOL PreCreateWindow(CREATESTRUCT& cs);
	afx_msg void OnBnClickedButtonComponentpredictmodelupdate();
};
